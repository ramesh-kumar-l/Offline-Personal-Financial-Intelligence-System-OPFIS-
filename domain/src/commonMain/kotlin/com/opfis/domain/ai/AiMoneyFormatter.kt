...
/**
 * Renders minor-units amounts inside composed [AiAnswer] text. Duplicates
 * `composeApp`'s `MoneyFormatter` on purpose: `:domain` must not depend
 * on the Presentation layer (ADR 0001), and answer text is domain logic,
 * not UI rendering.
 */
internal object AiMoneyFormatter {
